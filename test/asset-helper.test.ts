...
import {HexAssetHelper3JS, QuadAssetHelper3JS} from "../src/assets/asset-helper"
...
describe("Asset Helper",()=>{        
    describe("For Hexagonal Maps",()=>{
        describe("Simple Asset Creation",()=>{
            let helper: HexAssetHelper3JS;
            let factory: RenderablesFactory;

            let s1: SinonSpy;

            beforeEach(()=>{
                helper = new HexAssetHelper3JS();
    ...
    describe("For Quad Maps",()=>{
        describe("Simple Asset Creation", ()=>{
            let helper: QuadAssetHelper3JS;
            
            let s1: SinonSpy;
        
            beforeEach(()=>{
                helper = new QuadAssetHelper3JS();            
                s1 = sinon.spy(helper, "registerAsset");
            })
            afterEach(()=>{
                s1.restore();
            })
            it("creates spawnable asset",async ()=>{
                const asset = await helper.asset("my fancy asset", "my fancy asset description", ASSET_RENDERABLE_JSONS.OBJECT_MY_FANCY_ASSET, "data:image/png;base64,")
                expect(asset.specs.kind).eq("QuadTile")
                expect(asset.specs.id).is.not.undefined;
                expect(asset.specs.description).is.not.undefined;                
            })
        })
