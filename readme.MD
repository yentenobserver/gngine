# ThreeJs Map Component

GNGine is a to-be tile game engine. As of today here are ready to use components that can be used for building tile games:
...
<script src="../../../dist/gamengine.umd.js"></script>
```

Then in Javascript initialize MapViewerComponent3JS within given HTMLCanvas element.

```javascript
const mapViewer = await gngine.MapViewerComponent3JS.getInstance(map, mapRenderablesSpecifications, htmlCanvasElement, eventHandler, new THREE.GLTFLoader());
```
...
<img alt="drawing" width="200" src="docs/images/docs3.png"/>
...
<img width="200" src="docs/images/docs4.png"/>

And it is rendered on map accordingly:

<img width="200" src="docs/images/docs5.png"/>
